...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/assets/js/jquery-1.9.0.js"></script>
		...
		$("#btn-chkeamil")
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath }/user/api?a=checkemail&email="
												+ email,
										type : "get",
										dataType : "json",
										data : "",
	...
	<div id="container">
		...
		<div id="content">
			<div id="user">
				...
				<form:form modelAttibute="userVo"
                  ...
                  <c:if test="${errors.hasFieldErrors('name') }">
					...
					<label class="block-label" for="email">이메일</label> <input
						...
						id="btn-chkeamil" type="button" value="중복체크"> <label
